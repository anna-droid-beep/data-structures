import unittest
from LinkedList.SinglyLinkedList import SinglyLinkedList, Node


class TestSinglyLinkedList(unittest.TestCase):

    def setUp(self) -> None:
        self.init_list = SinglyLinkedList()

        self.single_node_list = SinglyLinkedList()
        single_node = Node(data="single", next=None)
        self.single_node_list.head = single_node
        self.single_node_list.tail = single_node
        self.single_node_list.size = 1

        self.head_tail_list = SinglyLinkedList()
        head_tail_node1 = Node(data=4, next=None)
        head_tail_node2 = Node(data=5, next=None)
        ...
        self.standard_list = SinglyLinkedList()
        standard_head = Node(data=6, next=None)
        standard_middle = Node(data=None, next=None)
        standard_tail = Node(data=1, next=None)
        standard_head.next = standard_middle
